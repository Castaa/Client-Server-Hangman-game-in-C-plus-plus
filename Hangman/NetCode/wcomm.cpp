...
bool WinNet::ConnectToDefaultGameServer()
{
  ...
  //return ConnectServerByIP("192.168.0.1", m_cPortNum) // alternative, connect to server via IP address directly

}


bool WinNet::ConnectServerByName(char *name, int port)
{
